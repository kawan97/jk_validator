...
bool isNull(dynamic value) => value == null;
  ...
  /// Checks if string is SSN (Social Security Number).
   bool isSSN(String s) => hasMatch(s,
  ...
  /// Checks if length of data is BETWEEN minLength to maxLength.
   bool isLengthBetween(dynamic value, int minLength, int maxLength) {
    if (isNull(value)) {
      return false;
    }
  ...
  /// Example 2 : this is an example text => This Is An Example Text
   ...
   String createPath(String path, [Iterable? segments]) {
